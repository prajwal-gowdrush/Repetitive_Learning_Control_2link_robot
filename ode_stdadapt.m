...
p1hat=X(5); p2hat=X(6); p3hat=X(7); fd1hat=X(8); fd2hat=X(9); fs1hat=X(10); fs2hat=X(11);
q=[q1;q2]; qdot=[q1dot;q2dot]; 
thetahat=[p1hat;p2hat;p3hat;fd1hat;fd2hat; fs1hat; fs2hat];
...
Y2=[alpha*(q1dot - qd1dot) - qd1doubledot, alpha*(q2dot - qd2dot) - qd2doubledot, 2*alpha*cos(q2)*(q1dot - qd1dot) - qd2doubledot*cos(q2) - 2*qd1doubledot*cos(q2) + alpha*cos(q2)*(q2dot - qd2dot) + sin(q2)*(qd2dot - alpha*(q2 - qd2))*(q1dot + q2dot) + q2dot*sin(q2)*(qd1dot - alpha*(q1 - qd1)), -q1dot,  0 -sign(q1dot) 0;    0, alpha*(q1dot - qd1dot) - qd2doubledot - qd1doubledot + alpha*(q2dot - qd2dot), alpha*cos(q2)*(q1dot - qd1dot) - qd1doubledot*cos(q2) - q1dot*sin(q2)*(qd1dot - alpha*(q1 - qd1)), 0, -q2dot 0 -sign(q2dot)];
